    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.length()==0){//ถ้า editext ว่าง คือยังไม่กรอกชื่อ จะย้อยกลับไปหน้า Game
                    Toast.makeText(getApplication(),"Please Enter your name",Toast.LENGTH_SHORT).show();
